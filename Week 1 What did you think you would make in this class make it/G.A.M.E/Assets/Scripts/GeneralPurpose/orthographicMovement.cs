...
public class orthographicMovement : MonoBehaviour {
    ...
    [SerializeField]
    private float maxXspeed; // the max speed in the X axis

    [SerializeField]
    private float maxYspeed; // the max speed in the Y axis
    ...
    void Update() {
        ...
        else if (rb2d.velocity.magnitude > maxXspeed || rb2d.velocity.y>maxYspeed) {
            rb2d.drag = 20;
        }
        else {
            rb2d.drag = 0;
